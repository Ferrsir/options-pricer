...
| Slide sanity checks | [`checks.py`](src/pricer/checks.py), 31 tests in [`tests/`](tests/) |
...
tests/        31 tests: reference values, parity, Greeks vs finite differences, tree convergence, LSMC, surface recovery, any-ticker data layer
