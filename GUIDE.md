...
| **Historical vol** | How much the stock *actually* moved in the past (the ticker box fills this in from Yahoo). | |
...
* **"The website says 'bundled snapshot' instead of live."** Yahoo does not allow browser pages to call it directly. Run `python -m pricer serve` locally for any ticker, live.
